...
def chatbot_fn(user_message, chat_history, language):
    ...
    try:
        ...
        system_prompt = (
            ...
            f"At the end of your answer, provide a section titled 'Referências' (if in Portuguese) or 'References' (if in English), listing all episodes you cited, as clickable links using the provided URLs from the context. Do not invent or guess URLs.\n"
...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown(f"<div style='margin-top:1em;'><a style='color:white;' href='#'>Ver código fonte</a></div>", unsafe_allow_html=True)
